...
data_folder = '/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/velosim/251126-2_rate.8/'
method = 'velovi_woprep'
dataset_short = 'velosim1126_rate.8'
dataset_long = 'velosim1126_rate.8'
fig_folder = '/home/users/y2564li/kzlinlab/projects/veloUncertainty/git/veloUncertainty/fig/velosim/251126-2_rate.8/'+method+'/'
...
sc.tl.umap(adata)
sc.pp.neighbors(adata1, n_neighbors=30, n_pcs=30)
sc.tl.umap(adata1)
sc.pp.neighbors(adata2, n_neighbors=30, n_pcs=30)
sc.tl.umap(adata2)

scv.tl.velocity_graph(adata,n_jobs=8)
scv.tl.velocity_graph(adata1,n_jobs=8)
...
# median cos_sim=-0.08216442, mean cos_sim=-0.08543708
# mean cos_sim with true: 0.01590006801740102
# median cos_sim with true:  0.016594388444974708
