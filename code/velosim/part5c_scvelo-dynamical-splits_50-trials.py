...
dynamical = []  # still collect in a list
for seed in range(50):
    ...
    dynamical.append(mean_sim)

dynamical = np.array(dynamical) 

import pandas as pd
pd.Series(dynamical, name="stochastic").to_csv("/home/users/kzlin/kzlinlab/projects/veloUncertainty/out/kevin/simulation/50-trials_dynamical.csv", index=False)