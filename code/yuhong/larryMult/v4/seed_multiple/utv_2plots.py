...
def utv_larryMult_plots(split_seed):
    ...
    print('correlation of velocity confidence btw splits='+str(np.corrcoef(split1.obs['velocity_confidence'],split2.obs['velocity_confidence']))) 
    ...
    print('mean of shuffled means='+str(np.round(np.mean(v2s_mean),4)))
    print('mean of shuffled medians='+str(np.round(np.mean(v2s_median),4)))
    print('variance of shuffled means='+str(np.round(np.var(v2s_mean),4)))
    print('variance of shuffled medians='+str(np.round(np.var(v2s_median),4)))
...
utv_larryMult_plots(split_seed=323)
utv_larryMult_plots(split_seed=326)
