...
def scv_larryMult(split_seed):
    ...
    print_message_with_time("################## All done with seed="+str(split_seed))

scv_larryMult(split_seed=323)
scv_larryMult(split_seed=326)
scv_larryMult(split_seed=329)
