...
def velovi_larryMult(split_seed):
...
velovi_larryMult(split_seed=320)
velovi_larryMult(split_seed=323)
velovi_larryMult(split_seed=326)
velovi_larryMult(split_seed=329)
