...
np.quantile(c1,[0.,.25,.5,.75,1.]) # [-0.17763719,  0.33300874,  0.52811921,  0.70085946,  0.92523086]
np.quantile(c2,[0.,.25,.5,.75,1.]) # [-0.1736351 ,  0.32847174,  0.52250959,  0.69029029,  0.92238906]
...
np.corrcoef(split1.obs['velocity_confidence'],split2.obs['velocity_confidence']) # 0.5352452
...
np.round(np.mean(v2s_mean),4) # 0.3533
np.round(np.mean(v2s_median),4) # 0.3143

np.round(np.var(v2s_mean),4) # 
np.round(np.var(v2s_median),4) 

# paired: 0.4976 0.5225
# shuffled: 0.3533 0.3143
