...
convert_object_pancreas <- function(s_mat,u_mat,fname,seed_arg) {
  ...
  path <- paste0("/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/pancreas_split/",fname,"_seed",seed_arg,".h5Seurat")
  print(path)
...
convert_object_pancreas(spliced_split1,unspliced_split1, "scvelo_pancreas_split1_seurat",seed_split)
convert_object_pancreas(spliced_split2, unspliced_split2, "scvelo_pancreas_split2_seurat",seed_split)
convert_object_pancreas(spliced_mat, unspliced_mat, "scvelo_pancreas_total_seurat",seed_split)
