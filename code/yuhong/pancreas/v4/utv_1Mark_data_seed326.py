...
def utv_run_model_Mark(data_version,velo_config,split_seed,grid_seed,celltype_label=celltype_label):
    gene_set_name = 'Mark'+str(grid_seed)
...
data_version = 'split1'
utv_run_model_Mark(data_version=data_version, velo_config=velo_config, split_seed=split_seed, grid_seed=grid_seed, celltype_label=celltype_label)
data_version = 'split2'
utv_run_model_Mark(data_version=data_version, velo_config=velo_config, split_seed=split_seed, grid_seed=grid_seed, celltype_label=celltype_label)
data_version = 'total'
utv_run_model_Mark(data_version=data_version, velo_config=velo_config, split_seed=split_seed, grid_seed=grid_seed, celltype_label=celltype_label)
