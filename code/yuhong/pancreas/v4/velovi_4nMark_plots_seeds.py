...
def velovi_create_plots(split_seed, grid_seed, velo_method):
    ...
    print('######## read data')
    total = sc.read_h5ad(data_folder+'adata_'+dataset_short+'_'+method+'_total.h5ad') # 
    split1 = sc.read_h5ad(data_folder+'adata_'+dataset_short+'_'+method+'_split1.h5ad') # 
    split2 = sc.read_h5ad(data_folder+'adata_'+dataset_short+'_'+method+'_split2.h5ad') # 
    vae_total = VELOVI.load(data_folder+'vae_'+dataset_short+'_'+method+'_total.pt', total)
    vae_split1 = VELOVI.load(data_folder+'vae_'+dataset_short+'_'+method+'_split1.pt', split1)
    vae_split2 = VELOVI.load(data_folder+'vae_'+dataset_short+'_'+method+'_split2.pt', split2)
    ...
    total.write(data_folder+'adata_'+dataset_short+'_'+method+'_total_outputAdded.h5ad') # 
    split1.write(data_folder+'adata_'+dataset_short+'_'+method+'_split1_outputAdded.h5ad') # 
    split2.write(data_folder+'adata_'+dataset_short+'_'+method+'_split2_outputAdded.h5ad') # 
    ## plot velocity
    print('######## velocity')
...
velovi_create_plots(split_seed=317, grid_seed=227, velo_method='velovi')
print('####################### 317 done')
velovi_create_plots(split_seed=320, grid_seed=230, velo_method='velovi')
print('####################### 320 done')
velovi_create_plots(split_seed=323, grid_seed=233, velo_method='velovi')
print('####################### 323 done')
velovi_create_plots(split_seed=326, grid_seed=236, velo_method='velovi')
print('####################### 326 done')
velovi_create_plots(split_seed=329, grid_seed=239, velo_method='velovi')
print('####################### 329 done')
