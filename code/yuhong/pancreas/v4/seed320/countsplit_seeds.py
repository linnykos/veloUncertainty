...
def write_split_data(split_seed):
...
write_split_data(split_seed=320)
print_message_with_time("####################### seed320 done")
write_split_data(split_seed=323)
print_message_with_time("####################### seed323 done")
write_split_data(split_seed=326)
print_message_with_time("####################### seed326 done")
write_split_data(split_seed=329)
print_message_with_time("####################### seed329 done")
