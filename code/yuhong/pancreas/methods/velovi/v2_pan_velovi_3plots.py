...
vae_split1 = VELOVI.load(data_folder+"v2_"+dataset_long+"/"+method+'/vae_pan_velovi_split1_v2.pt', split1)

split2 = sc.read_h5ad(data_folder+"v2_"+dataset_long+"/"+method+"/adata_"+dataset_short+"_"+method+"_split2_v2.h5ad")
vae_split2 = VELOVI.load(data_folder+"v2_"+dataset_long+"/"+method+'/vae_pan_velovi_split2_v2.pt', split2)
