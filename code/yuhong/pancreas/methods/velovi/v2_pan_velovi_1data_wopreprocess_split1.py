...
savedata_folder = data_folder+"v2_pancreas/velovi/wopreprocess/"
data_version = "split1"
...
vae.save(savedata_folder+'vae_pan_velovi_'+data_version+'_wopreprocess_v2.pt',overwrite=True)
...
adata.write(filename=savedata_folder+"adata_pan_velovi_"+data_version+"_wopreprocess_v2.h5ad")
