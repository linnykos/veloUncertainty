...
adata_split1.write(data_folder+'v2_pancreas/sct/adata_pan_sct_seed317_split1_v2.h5ad')
tnode_split1.save_model(save_dir=data_folder+'v2_pancreas/sct/', save_prefix='tnode_pan_sct_seed317_split1_v2')
...
adata_split2.write(data_folder+'v2_pancreas/sct/adata_pan_sct_seed317_split2_v2.h5ad')
tnode_split2.save_model(save_dir=data_folder+'v2_pancreas/sct/', save_prefix='tnode_pan_sct_seed317_split2_v2')
...
total.write(data_folder+'v2_pancreas/sct/adata_pan_sct_total_v2.h5ad')
tnode_total.save_model(save_dir=data_folder+'v2_pancreas/sct/', save_prefix='tnode_pan_sct_total_v2')
