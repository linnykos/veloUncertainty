...
data_path <- "/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/pancreas_velovi/"
scvelo_sc <- zellkonverter::readH5AD(file=paste0(data_path,"pancreas_velovi_preprocess.h5ad"))
...
convert_object_pancreas <- function(s_mat,u_mat,fname,seed_arg) {
  ...
  path <- paste0(data_path,"pancreas_seed",seed_arg,fname,".h5Seurat")
  print(path)
