...
plt.text(.25, 1000, 'mean cosine similarity = '+str(mean_seed317), color='blue', fontsize=10)
plt.text(.25, 900, 'split1 number of genes = '+str(Ngenes_317s1), color='blue', fontsize=10)
plt.text(.25, 800, 'split2 number of genes = '+str(Ngenes_317s2), color='blue', fontsize=10)
## add labels and title
plt.xlabel('cosine similarity (seed317)')
plt.ylabel('Frequency')
plt.title('Histogram of cosine similarity, pan+utv_utvgenes, Ngenes='+str(Ngenes_317common))
plt.savefig('/home/users/y2564li/kzlinlab/projects/veloUncertainty/git/veloUncertainty/fig/yuhong/pancreas/unitvelo_utvgenes/pan_utv_seed317_cos_sim_hist_utvgenes.png')
plt.clf()
...
scv.pl.velocity_embedding_stream(adata_total_res,basis="umap",color="cos_sim_317",cmap="coolwarm",
                                 save="/home/users/y2564li/kzlinlab/projects/veloUncertainty/git/veloUncertainty/fig/yuhong/pancreas/unitvelo_utvgenes/pan_utv_seed317_cos_sim_umaptotal_utvgenes.png")

adata_pre = scv.read('/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/pan_utv_utvgenes/pan_utv_preprocess.h5ad')
adata_total_res.obsm['X_umap'] = adata_pre.obsm['X_umap'].copy()
scv.pl.velocity_embedding_stream(adata_total_res,basis="umap",color="cos_sim_317",cmap="coolwarm",
                                 save="/home/users/y2564li/kzlinlab/projects/veloUncertainty/git/veloUncertainty/fig/yuhong/pancreas/unitvelo_utvgenes/pan_utv_seed317_cos_sim_umappreproc_utvgenes.png")
...
## add number of genes used in each split
plt.text(.25, 1000, 'mean cosine similarity = '+str(mean_seed320), color='blue', fontsize=10)
plt.text(.25, 900, 'split1 number of genes = '+str(Ngenes_320s1), color='blue', fontsize=10)
plt.text(.25, 800, 'split2 number of genes = '+str(Ngenes_320s2), color='blue', fontsize=10)
## add labels and title
plt.xlabel('cosine similarity (seed320)')
plt.ylabel('Frequency')
plt.title('Histogram of cosine similarity, pan+utv_utvgenes, Ngenes='+str(Ngenes_320common))
plt.savefig('/home/users/y2564li/kzlinlab/projects/veloUncertainty/git/veloUncertainty/fig/yuhong/pancreas/unitvelo_utvgenes/pan_utv_seed320_cos_sim_hist_utvgenes.png')
plt.clf()
...
scv.pl.velocity_embedding_stream(adata_total_res,basis="umap",color="cos_sim_320",cmap="coolwarm",
                                 save="/home/users/y2564li/kzlinlab/projects/veloUncertainty/git/veloUncertainty/fig/yuhong/pancreas/unitvelo_utvgenes/pan_utv_seed320_cos_sim_umaptotal_utvgenes.png")

adata_total_res.obsm['X_umap'] = adata_pre.obsm['X_umap'].copy()
scv.pl.velocity_embedding_stream(adata_total_res,basis="umap",color="cos_sim_320",cmap="coolwarm",
                                 save="/home/users/y2564li/kzlinlab/projects/veloUncertainty/git/veloUncertainty/fig/yuhong/pancreas/unitvelo_utvgenes/pan_utv_seed320_cos_sim_umappreproc_utvgenes.png")
