...
scvelo_sc <- zellkonverter::readH5AD(file="/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/pan_utv_utvgenes/pan_utv_preprocess.h5ad")
...
convert_object_pancreas <- function(s_mat,u_mat,fname,seed_arg) {
  ...
  path <- paste0("/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/pan_utv_utvgenes/","pan_utvgenes_seed",seed_arg,fname,".h5Seurat")
  print(path)
