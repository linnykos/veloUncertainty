...
def run_scv_nGPCgrid(split_seed, grid_seed):
...
def plot_scv_nGPCgrid(split_seed, grid_seed):
    gene_set_name = 'nGPCgrid'+str(grid_seed)
    method = 'scv_'+gene_set_name
...
run_scv_nGPCgrid(split_seed=317, grid_seed=227)
plot_scv_nGPCgrid(split_seed=317, grid_seed=227)

run_scv_nGPCgrid(split_seed=320, grid_seed=230)
plot_scv_nGPCgrid(split_seed=320, grid_seed=230)

run_scv_nGPCgrid(split_seed=323, grid_seed=233)
plot_scv_nGPCgrid(split_seed=323, grid_seed=233)

run_scv_nGPCgrid(split_seed=326, grid_seed=236)
plot_scv_nGPCgrid(split_seed=326, grid_seed=236)

run_scv_nGPCgrid(split_seed=329, grid_seed=239)
plot_scv_nGPCgrid(split_seed=329, grid_seed=239)
...
df.to_csv(data_folder+'cos_sim_across_seeds_nGPCgrid_scv.csv')
