...
split1.write(data_folder+'seed'+str(split_seed)+'_glf_split1_GPC_utv0.h5ad')
split2.write(data_folder+'seed'+str(split_seed)+'_glf_split2_GPC_utv0.h5ad')
...
def utv_run_model_v4_GPC(data_version,velo_config,data_folder,split_seed,celltype_label='cluster_name'):
    if data_version=='total':
        ...
        adata.write_h5ad(data_folder+'seed'+str(split_seed)+'/'+method+'/'+'seed'+str(split_seed)+'_glf_'+data_version+'_GPC_utv.h5ad')

data_folder = '/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/v4_greenleaf/'

# split1
utv_run_model_v4_GPC(data_version='split1', velo_config=velo_config, data_folder=data_folder, split_seed=split_seed, celltype_label='cluster_name')
# split2
utv_run_model_v4_GPC(data_version='split2', velo_config=velo_config, data_folder=data_folder, split_seed=split_seed, celltype_label='cluster_name')
