...
velovi_create_plots(split_seed=317, grid_seed=227, velo_method=velo_method)
print('####################### 317 done')
velovi_create_plots(split_seed=320, grid_seed=230, velo_method=velo_method)
print('####################### 320 done')
velovi_create_plots(split_seed=323, grid_seed=233, velo_method=velo_method)
print('####################### 323 done')
velovi_create_plots(split_seed=326, grid_seed=236, velo_method=velo_method)
print('####################### 326 done')
velovi_create_plots(split_seed=329, grid_seed=239, velo_method=velo_method)
print('####################### 329 done')
