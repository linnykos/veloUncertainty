...
scvelo_sc <- zellkonverter::readH5AD(file="/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/erythroid_split/adata_erythroid_preprocess_harmony.h5ad")
...
convert_object_erythroid <- function(s_mat,u_mat,fname,seed_arg) {
  ...
  seurat_res@meta.data <- data.frame("celltype"=as.character(scvelo_seurat@meta.data$celltype),
                                     "sequencing.batch"=scvelo_seurat@meta.data$sequencing.batch, ## original 1,2,3
                                     "sample"=scvelo_seurat@meta.data$sample) ## original 2,...,37
