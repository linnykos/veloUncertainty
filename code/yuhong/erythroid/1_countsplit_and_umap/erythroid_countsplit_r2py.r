...
scvelo_sc <- zellkonverter::readH5AD(file="/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/erythroid_split/erythroid_countsplit_py2r.h5ad")
...
convert_object_erythroid <- function(s_mat,u_mat,fname,seed_arg) {
  ...
  path <- paste0("/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/erythroid_split/","erythroid_seed",seed_arg,fname,".h5Seurat")
  print(path)
