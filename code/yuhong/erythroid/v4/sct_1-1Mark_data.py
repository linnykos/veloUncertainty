...
for split_seed in [317, 320, 323, 326, 329]:
    run_sct_ery_Mark(gene_set_name='Mark',split_version='split1',split_seed=split_seed,sct_seed=615)
    run_sct_ery_Mark(gene_set_name='Mark',split_version='split2',split_seed=split_seed,sct_seed=615)
    run_sct_ery_Mark(gene_set_name='Mark',split_version='total',split_seed=split_seed,sct_seed=615)
