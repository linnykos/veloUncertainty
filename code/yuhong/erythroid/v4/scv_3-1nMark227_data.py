...
for i in range(4):
    ...
    split1 = sc.read_h5ad(data_folder+'seed'+str(split_seed)+'_'+dataset_short+'_split1_allgenes.h5ad')[:,genes]
    split2 = sc.read_h5ad(data_folder+'seed'+str(split_seed)+'_'+dataset_short+'_split2_allgenes.h5ad')[:,genes]
