...
scvelo_sc <- zellkonverter::readH5AD(file=paste0(data_folder,"erythroid_velovi_preprocess.h5ad"))
...
convert_object_erythroid <- function(s_mat,u_mat,fname,seed_arg) {
  ...
  path <- paste0(data_folder,"erythroid_seed",seed_arg,fname,".h5Seurat")
  print(path)
...
s1_seed317 <- LoadH5Seurat(paste0(data_folder, "erythroid_seed317_split1_seurat.h5Seurat"))
s2_seed317 <- LoadH5Seurat(paste0(data_folder, "erythroid_seed317_split2_seurat.h5Seurat"))
s1_seed320 <- LoadH5Seurat(paste0(data_folder, "erythroid_seed320_split1_seurat.h5Seurat"))
s2_seed320 <- LoadH5Seurat(paste0(data_folder, "erythroid_seed320_split2_seurat.h5Seurat"))
...
png(file = paste0(fig_folder,"corr_seed317.png"), height = 1000, width = 1800, units = "px", res = 300)
par(mfrow=c(1,2))
...
png(file = paste0(fig_folder,"corr_seed320.png"), height = 1000, width = 1800, units = "px", res = 300)
par(mfrow=c(1,2))
plot(cor_spliced_seed320, ylim = c(-1,1), pch = 16, col = color_values, 
     main="Spliced (VeloVI on erythroid data)",ylab="corr",cex=.7,cex.main=.8) 
plot(cor_unspliced_seed320, ylim = c(-1,1), pch = 16, col = color_values, 
     main="Unspliced (VeloVI on erythroid data)",ylab="corr",cex=.7,cex.main=.8)
graphics.off()
