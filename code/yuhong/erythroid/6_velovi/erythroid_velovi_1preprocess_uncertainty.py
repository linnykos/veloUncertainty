...
adata = sc.read(filename="/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/erythroid_velovi/erythroid_velovi_preprocess.h5ad")
vae = VELOVI.load(data_folder+'vae_erythroid_preprocess.pt', adata)
...
print("########################### intrinsic uncertainty computed ###########################")
...
print("########################### extrinsic uncertainty computed ###########################")
...
plt.clf()
print("########################### permutation scores computed ###########################")
