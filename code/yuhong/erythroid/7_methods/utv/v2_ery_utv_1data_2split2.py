...
adata_split2.write_h5ad(filename="/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/Writeup16_v2_utv/tmp_v2_ery_split2.h5ad")
adata_split2 = utv.run_model("/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/Writeup16_v2_utv/tmp_v2_ery_split2.h5ad", 'celltype', config_file=velo_config)

print_message_with_time("#################### Write data (intermediate version)")
adata_split2.write_h5ad(data_folder+'v2_erythroid/utv/backup/adata_ery_utv_split2.h5ad')
### 
...
adata_split2.write_h5ad(data_folder+'v2_erythroid/utv/adata_ery_utv_split2_v2.h5ad')
