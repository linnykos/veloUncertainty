...
savedata_folder = data_folder+"v2_erythroid/velovi/wopreprocess/"
...
vae_split1.save(savedata_folder+'vae_ery_velovi_split1_wopreprocess_v2.pt',overwrite=True)
...
adata_split1.write(filename=savedata_folder+"adata_ery_velovi_split1_wopreprocess_v2.h5ad")
...
vae_split2.save(savedata_folder+'vae_ery_velovi_split2_wopreprocess_v2.pt',overwrite=True)
...
adata_split2.write(filename=savedata_folder+"adata_ery_velovi_split2_wopreprocess_v2.h5ad")
...
vae_total.save(savedata_folder+'vae_ery_velovi_total_wopreprocess_v2.pt',overwrite=True)
...
adata_total.write(filename=savedata_folder+"adata_ery_velovi_total_wopreprocess_v2.h5ad")
