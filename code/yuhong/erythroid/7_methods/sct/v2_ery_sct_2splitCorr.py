...
s1 = sc.read_h5ad(data_folder+'v2_erythroid/seed317_split1_allgenes.h5ad')
s2 = sc.read_h5ad(data_folder+'v2_erythroid/seed317_split2_allgenes.h5ad')
...
common_genes.shape # 1304 common genes
np.intersect1d(np.array(split1.var.index), np.array(total.var.index)).shape # 229
np.intersect1d(np.array(split2.var.index), np.array(total.var.index)).shape # 244
