...
scvelo_sc <- zellkonverter::readH5AD(file="/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/simulation/sim2.h5ad")
...
convert_object_erythroid <- function(s_mat,u_mat,fname,seed_arg) {
  ...
  path <- paste0("/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/simulation/","sim2_seed",seed_arg,fname,".h5Seurat")
  print(path)
...
plot(cor_spliced_seed320, ylim = c(-1,1), pch = 16, col = color_values, 
     main="Spliced (sim2, seed=320)",ylab="corr",cex=.7,cex.main=.8) 
plot(cor_unspliced_seed320, ylim = c(-1,1), pch = 16, col = color_values, 
     main="Unspliced (sim2, seed=320)",ylab="corr",cex=.7,cex.main=.8)
graphics.off()
