...
#raw = sc.read_h5ad(data_folder+"v4_larry/larry.h5ad")
...
adata_split2.write(data_folder+'v4_'+dataset_long+'/seed317/'+method+'/adata_'+dataset_short+'_'+method+'_split2_v4.h5ad')
tnode_split2.save_model(save_dir=data_folder+'v4_'+dataset_long+'/seed317/'+method+'/', save_prefix='tnode_'+dataset_short+'_'+method+'_split2_v4')
