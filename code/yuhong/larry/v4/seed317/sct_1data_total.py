...
total.write(data_folder+'v4_'+dataset_long+'/seed317/'+method+'/adata_'+dataset_short+'_'+method+'_total_v4.h5ad')
tnode_total.save_model(save_dir=data_folder+'v4_'+dataset_long+'/seed317/'+method+'/', save_prefix='tnode_'+dataset_short+'_'+method+'_total_v4')
