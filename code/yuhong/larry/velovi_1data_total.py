...
savedata_folder = data_folder+"v2_larry/velovi/"
...
vae.save(savedata_folder+'vae_larry_velovi_'+data_version+'_v2.pt',overwrite=True)
...
adata.write(filename=savedata_folder+"adata_larry_velovi_"+data_version+"_v2.h5ad")
