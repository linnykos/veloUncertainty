...
savedata_folder = data_folder+"v2_larry/velovi/wopreprocess/"
...
vae.save(savedata_folder+'vae_larry_velovi_'+data_version+'_wopreprocess_v2.pt',overwrite=True)
...
adata.write(filename=savedata_folder+"adata_larry_velovi_"+data_version+"_wopreprocess_v2.h5ad")
