...
savedata_folder = data_folder+"v2_pancreasINC/velovi/"
...
vae.save(savedata_folder+'vae_panINC_velovi_'+data_version+'_v2.pt',overwrite=True)
...
adata.write(filename=savedata_folder+"adata_panINC_velovi_"+data_version+"_v2.h5ad")
