...
def velovi_woprep_panINC_plots(split_seed):
    ...
    ## ptime
    print_message_with_time(str(split_seed)+': velocity pseudotime plots') 
    ...
    # latent time
    print_message_with_time(str(split_seed)+': latent time plots')
...
velovi_woprep_panINC_plots(split_seed=320)
velovi_woprep_panINC_plots(split_seed=323)
velovi_woprep_panINC_plots(split_seed=326)
velovi_woprep_panINC_plots(split_seed=329)
