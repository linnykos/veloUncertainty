...
df.to_csv(data_folder+'v2_'+dataset_long+'/'+method+'/'+dataset_short+'_'+method+'_spearman_velo_timestep_splits.csv')
print_message_with_time('######### Wrote data to '+data_folder+'v2_'+dataset_long+'/'+method+'/'+dataset_short+'_'+method+'_spearman_velo_timestep_splits.csv')