...
def plot_sct_ery_nMark(gene_set_name, split_seed, plot_total=True):
    ...
    total = sc.read_h5ad(data_folder+'seed317'+'/'+method+'/adata_'+dataset_short+'_'+method+'_total_outputAdded.h5ad')
...
for i in range(5):
    ...
    plot_sct_ery_nMark(gene_set_name=gene_set_name, split_seed=split_seed, plot_total=False)
