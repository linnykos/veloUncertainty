...
total = sc.read(data_folder+'v4_'+dataset_long+'/glf_genes_gsea/glf_total_gsea_genes.h5ad')
split1 = sc.read(data_folder+'v4_'+dataset_long+'/glf_genes_gsea/seed'+str(split_seed)+'_'+dataset_short+'_split1_gsea_genes.h5ad')
split2 = sc.read(data_folder+'v4_'+dataset_long+'/glf_genes_gsea/seed'+str(split_seed)+'_'+dataset_short+'_split2_gsea_genes.h5ad')
...
velovi_run_model_glf_gsea(adata=total, data_version='total', dataset_short=dataset_short, dataset_long=dataset_long, method=method,
						  data_folder=data_folder, split_seed=split_seed, data_suffix='gsea')
