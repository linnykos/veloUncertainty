...
# data_suffix = 'gsea' or 'gseactrl'
def glf_gsea_velovi_create_plots(split_seed, method, data_suffix):
    data_folder = '/home/users/y2564li/kzlinlab/projects/veloUncertainty/out/yuhong/data/v4_greenleaf/seed'+str(split_seed)+'/'+method+'_'+data_suffix+'/'
...
glf_gsea_velovi_create_plots(split_seed=317, method=velo_method, data_suffix='gseactrl227')
print('####################### 317 done')
glf_gsea_velovi_create_plots(split_seed=320, method=velo_method, data_suffix='gseactrl230')
print('####################### 320 done')
glf_gsea_velovi_create_plots(split_seed=323, method=velo_method, data_suffix='gseactrl233')
print('####################### 323 done')
glf_gsea_velovi_create_plots(split_seed=326, method=velo_method, data_suffix='gseactrl236')
print('####################### 326 done')
glf_gsea_velovi_create_plots(split_seed=329, method=velo_method, data_suffix='gseactrl239')
print('####################### 329 done')
