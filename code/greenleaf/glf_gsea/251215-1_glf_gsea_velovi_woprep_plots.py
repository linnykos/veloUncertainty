...
#glf_gsea_velovi_create_plots(split_seed=317, method=velo_method, data_suffix='gsea')
#print('####################### 317 done')
glf_gsea_velovi_create_plots(split_seed=320, method=velo_method, data_suffix='gsea')
print('####################### 320 done')
glf_gsea_velovi_create_plots(split_seed=323, method=velo_method, data_suffix='gsea')
print('####################### 323 done')
glf_gsea_velovi_create_plots(split_seed=326, method=velo_method, data_suffix='gsea')
print('####################### 326 done')
glf_gsea_velovi_create_plots(split_seed=329, method=velo_method, data_suffix='gsea')
print('####################### 329 done')
