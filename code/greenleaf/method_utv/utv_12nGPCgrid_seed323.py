...
def utv_run_model_v4_nGPCgrid(data_version,velo_config,split_seed,grid_seed,celltype_label='cluster_name'):
...
# total
utv_run_model_v4_nGPCgrid(data_version='total', velo_config=velo_config, split_seed=split_seed, grid_seed=grid_seed, celltype_label='cluster_name')
# split1
utv_run_model_v4_nGPCgrid(data_version='split1', velo_config=velo_config, split_seed=split_seed, grid_seed=grid_seed, celltype_label='cluster_name')
# split2
utv_run_model_v4_nGPCgrid(data_version='split2', velo_config=velo_config, split_seed=split_seed, grid_seed=grid_seed, celltype_label='cluster_name')
