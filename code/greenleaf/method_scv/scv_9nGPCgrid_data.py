...
print('################## Read data') 
total = sc.read(data_folder+'glf_total_nGPCgrid.h5ad')
split1 = sc.read(data_folder+'glf_seed'+str(split_seed)+'_split1_nGPCgrid.h5ad')
split2 = sc.read(data_folder+'glf_seed'+str(split_seed)+'_split2_nGPCgrid.h5ad')
