...
method = 'velovi_woprep_'+gene_set_name
...
velovi_run_model(adata=split1,data_version='split1',dataset_short=dataset_short,method=method,data_folder=data_folder,split_seed=split_seed)
velovi_run_model(adata=split2,data_version='split2',dataset_short=dataset_short,method=method,data_folder=data_folder,split_seed=split_seed)
velovi_run_model(adata=total,data_version='total',dataset_short=dataset_short,method=method,data_folder=data_folder,split_seed=split_seed)
