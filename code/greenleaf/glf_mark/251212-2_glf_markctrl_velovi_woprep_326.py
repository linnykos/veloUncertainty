...
total_mark = sc.read(data_folder+'v4_'+dataset_long+'/glf_genes_mark/glf_total_markctrl'+str(grid_seed)+'.h5ad')
split1_mark = sc.read(data_folder+'v4_'+dataset_long+'/glf_genes_mark/'+dataset_short+'_split1_markctrl'+str(grid_seed)+'.h5ad')
split2_mark = sc.read(data_folder+'v4_'+dataset_long+'/glf_genes_mark/'+dataset_short+'_split2_markctrl'+str(grid_seed)+'.h5ad')

method = 'velovi_woprep'
file_suffix = 'glf_markctrl'+str(grid_seed)
