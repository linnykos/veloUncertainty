...
adata_full, velocity_graph = prepare_adata_laplacian(adata_kernel=adata_kernel, adata_full=adata_full, subset_key=None, subset_value=None)
...
# Save to CSV
output_path = "/home/users/kzlin/kzlinlab/projects/veloUncertainty/out/kevin/Writeup15/Writeup15_greenleaf_gene_laplacian_scores_velovi-woprep_chung.csv"
