...
np.quantile(c1,[0.,.25,.5,.75,1.]) # [0.31911555, 0.6523581 , 0.70039088, 0.74800096, 0.93503559]
np.quantile(c2,[0.,.25,.5,.75,1.]) # [0.31371606, 0.63428094, 0.68121909, 0.72673481, 0.93113888]
...
np.corrcoef(split1.obs['velocity_confidence'],split2.obs['velocity_confidence']) # 0.17833356
...
# paired: 0.6766 0.6812
# shuffled: 0.3885 0.4121
