...
c1,n1 = compute_cosine_similarity_intersect(split1,split2,method) # 506
c2,n2 = compute_cosine_similarity_union(split1,split2,method) # 743
np.quantile(c1,[0.,.25,.5,.75,1.]) # [0.1699459 , 0.38152738, 0.42834277, 0.4730593 , 0.62368536]
np.quantile(c2,[0.,.25,.5,.75,1.]) # [0.15169376, 0.33494834, 0.37861721, 0.42204591, 0.56099349]
...
np.corrcoef(split1.obs['velocity_confidence'],split2.obs['velocity_confidence']) # 0.39564399
