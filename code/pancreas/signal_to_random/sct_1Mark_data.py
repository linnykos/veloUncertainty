...
######################################################
def read_data_and_run_sct_Mark(adata, dataset_short,dataset_long,method,savedata_folder,split_version,sct_seed):
...
for i in range(5):
    ...
    gene_set_name = 'Mark'+str(grid_seed)
    ...
    read_data_and_run_sct_Mark(split1,dataset_short,dataset_long,method,savedata_folder,split_version='split1',sct_seed=sct_seed)
    read_data_and_run_sct_Mark(split2,dataset_short,dataset_long,method,savedata_folder,split_version='split2',sct_seed=sct_seed)
    read_data_and_run_sct_Mark(total,dataset_short,dataset_long,method,savedata_folder,split_version='total',sct_seed=sct_seed)
