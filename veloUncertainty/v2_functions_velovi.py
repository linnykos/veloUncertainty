...
def compute_intrinisic_uncertainty(adata_in,vae,adata_raw,dataset,fig_folder,fig_name,sample_seed=2216,n_samples=100):
    ...
    # umapCompute
    plot_uncertainty_velovi(adata=adata,dataset=dataset,uncertainty_type='int',umap_type='umapCompute',fig_folder=fig_folder,fig_name=fig_name)
    # umapOriginal
    adata.obsm['X_umap'] = adata_raw.obsm['X_umap']
    plot_uncertainty_velovi(adata=adata,dataset=dataset,uncertainty_type='int',umap_type='umapOriginal',fig_folder=fig_folder,fig_name=fig_name)
...
def compute_extrinisic_uncertainty(adata_in,vae,adata_raw,dataset,fig_folder,fig_name,sample_seed=2216,n_samples=25):
    ...
    # umapCompute
    plot_uncertainty_velovi(adata=adata,dataset=dataset,uncertainty_type='ext',umap_type='umapCompute',fig_folder=fig_folder,fig_name=fig_name)
    # umapOriginal
    adata.obsm['X_umap'] = adata_raw.obsm['X_umap']
    plot_uncertainty_velovi(adata=adata,dataset=dataset,uncertainty_type='ext',umap_type='umapOriginal',fig_folder=fig_folder,fig_name=fig_name)
